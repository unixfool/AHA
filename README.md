...
`4` <b>Step:</b> Gmail Login `AHA/app/src/main/java/aha/ircayuda/org/MainActivity.java` <br/><b>`#1589F0`Line 174:`#1589F0`</b> `if (url.contains("Your-Facebook-CallBack-URL")) {return false;}`<br/>
